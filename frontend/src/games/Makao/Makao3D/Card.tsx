...
const Card: React.FC<CardProps> = ({ cardKey, textures, position, rotation = [0, 0, 0], scale = 1, flipped = false, fromPosition, fromRotation, delay = 0, onClick }) => {
  ...
  return (
    <animated.group position={springPosition as any} rotation={springRotation as any} onClick={onClick}>
      {/* Front Face */}
