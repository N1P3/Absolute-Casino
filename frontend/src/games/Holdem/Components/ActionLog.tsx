...
const ActionLog: React.FC<ActionLogProps> = ({ actions }) => {
  return (
    <div className="absolute left-4 top-24 w-64 bg-black/60 text-white p-3 rounded-lg border border-white/20 backdrop-blur-sm z-10 max-h-[300px] overflow-y-auto">
